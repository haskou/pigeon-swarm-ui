...
const CommunityDiscoveryDialog = lazy(() =>
  import('../../../communities/presentation/components/communityDiscoveryDialog').then((module) => ({
    default: module.CommunityDiscoveryDialog,
  })),
);
const CreateCommunityDialog = lazy(() =>
  import('../../../communities/presentation/components/createCommunityDialog').then((module) => ({
    default: module.CreateCommunityDialog,
  })),
);
const CreateConversationDialog = lazy(() =>
  import('../../../conversations/presentation/components/createConversationDialog').then((module) => ({
    default: module.CreateConversationDialog,
  })),
);
const IncomingCallDialog = lazy(() =>
  import('../../../calls/presentation/components/incomingCallDialog').then((module) => ({
...
const NotificationsPanel = lazy(() =>
  import(
    '../../../notifications/presentation/components/notificationsPanel'
  ).then((module) => ({
