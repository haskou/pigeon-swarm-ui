  ...
  return (
    <>
      <button
        ...
        className={cx(
          'flex w-40 touch-none select-none rounded-2xl p-0.5 transition hover:bg-white/10 sm:w-48',
      ...
      >
        <img
          ...
          decoding="async"
          loading="lazy"
          className="aspect-square h-40 w-40 object-contain sm:h-48 sm:w-48"
          draggable={false}
        />
      </button>
