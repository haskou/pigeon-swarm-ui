...
function StickerPressPreview({
  ...
  return createPortal(
    <div
      className="pointer-events-none fixed z-[120] grid h-[21rem] w-[21rem] place-items-center rounded-3xl border border-white/15 bg-black/70 p-3 shadow-2xl shadow-black/50 backdrop-blur-xl"
