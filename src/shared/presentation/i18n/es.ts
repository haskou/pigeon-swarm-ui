...
export const es = {
  ...
  calls: {
    ...
    microphoneDenied:
      'El navegador no ha concedido permiso de microfono.',
    microphoneHelp: 'Abrir ayuda',
    microphoneInUse:
      'El microfono esta ocupado en otra app o pestana.',
    microphoneMissingDevice: 'No se ha encontrado ningun microfono.',
    microphoneNotSecure:
      'El microfono requiere HTTPS o una app instalada.',
    ...
    microphoneUnsupported:
      'Este navegador no expone captura de microfono.',
  ...
  stickers: {
    ...
    noStickerPacks: 'Aun no hay packs de stickers. Abre Gestionar para crear o guardar uno.',
    manage: 'Gestionar',
  ...
  notifications: {
    ...
    levelMentions: 'Solo @mentions',
    levelNone: 'Nada',
    mobilePushEnabled: 'Notificaciones push para movil',
    ...
    muteIndefinitely: 'Hasta que se vuelva a activar',
    muteScope: 'Silenciar',
    ...
    suppressRoleMentions: 'Suprimir @mentions de rol',
