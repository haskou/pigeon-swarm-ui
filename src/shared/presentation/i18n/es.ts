...
export const es = {
  ...
  communities: {
    ...
    addMemberCreateInviteLink: 'Crear enlace de invitacion',
    ...
    clearCommunitySearch: 'Vaciar busqueda de comunidades',
    ...
    createBody:
      'Crea un espacio privado dentro de una de tus redes. Los miembros y canales solo son visibles para la comunidad.',
    ...
    linkKeyMissing:
      'A este enlace de invitacion le falta la clave de comunidad. Pide un enlace nuevo antes de unirte.',
    ...
    privateCommunityHelp: 'Los mensajes permanecen cifrados extremo a extremo.',
    profile: 'Perfil',
