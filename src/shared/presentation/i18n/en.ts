...
export const en = {
  ...
  chat: {
    ...
    copyPrivateKeyAction: 'Share encrypted key',
    copyPrivateKeyBody:
  ...
  encryption: {
    ...
    conversationTitle: 'Conversation encryption',
    createdAt: 'Created',
    empty: 'No value',
    keys: 'Keys',
    ...
    plaintext: 'Plaintext',
    public: 'Public plaintext',
    publicCommunityNote:
      'This public community stores searchable plaintext messages. No community message key is used for this channel.',
    ready: 'End-to-end encryption active',
    scope: 'Scope',
  ...
  network: {
    ...
    configureRelay: 'Configure node connectivity',
    configureRelayBody:
      'Optional. Set the public host and ports before connecting this node to a network.',
  ...
  nodeSettings: {
    ...
    relay: 'Relay',
    relayAdvertised: 'Available',
    relayAutoEnabled: 'Automatic',
    relayCheckingPorts: 'Checking...',
    relayCheckPorts: 'Check access',
    relayDisabled: 'Disabled',
    relayDiscoveryEnabled: 'Find published addresses',
    relayEnabled: 'Enabled',
    relayLoadError: 'Connection settings could not be loaded.',
    relayLoading: 'Loading configuration...',
    relayPeer: 'Connection identifier',
    ...
    relayRunning: 'Active',
    relaySave: 'Save configuration',
    relaySaveError: 'Connection settings could not be saved.',
    relaySaveSuccess: 'Configuration saved.',
  ...
  profile: {
    ...
    keychainHelp:
      'Available local keys are shown censored. Copy only when you need to inspect or share a key package.',
    ...
    noKeychainKeys: 'No keys in this keychain.',
    ...
    technicalDetails: 'Show nerdy data',
    technicalDetailsHelp:
      'Shows technical identifiers, versions, encryption metadata and diagnostic controls throughout the app. This preference is stored only in this browser.',
    technicalDetailsWarning:
      'Technical data can expose sensitive metadata. Do not share it unless you understand what it contains.',
