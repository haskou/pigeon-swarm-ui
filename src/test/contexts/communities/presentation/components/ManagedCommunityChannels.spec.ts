...
import { ManagedCommunityChannels } from '../../../../../contexts/communities/presentation/components/ManagedCommunityChannels';
...
describe(ManagedCommunityChannels.name, () => {
  ...
  it('ignores deleted channels when ordering saved channels', () => {
    expect(
      ManagedCommunityChannels.orderSavedChannels([opsTextChannel], {
        channelDrafts: { 'channel-1': 'general', 'channel-2': 'ops' },
